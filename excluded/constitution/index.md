...
* Be a member of AustraliaSim as per section 2.2; or
...
### 4.1 Limitations on holding a position
...
* A meta position is automatically vacant if-
	...
	* They resign; or
    * They are determined to have been ineligible for the role at the time of election; or
    * The Administratiors and Guardians vote unanimously to remove them or;
        * This method cannot be used to remove an Administrator or Guardian.
    * The holder is removed via a successful vote of no confidence.

### 4.5 Votes of no confidence
...
* Votes of no confidence require—
    ...
    * six seconders.
* When a vote of no confidence reaches the set requirements, the procedure for the Meta Referendum must be held within 2 days.
...
### 6.1 Powers and de-facto appointements
...
##### 6.5.1 Responsibilites


###### 6.5.1.1 Parliament and High Court
...
###### 6.5.1.2 Electoral Commissioner
...
### 8.1 Notice of enactment

At least three days prior to the enactment of a Rule, a post on r/AustraliaSimMeta must be made announcing the enactment of the Meta Rule, containing the full text of the Rule.

### 8.2 Retrospective Rules

A Rule must which is retrospective must receive approval in a Meta Referendum.

### 8.3 Rejecting Rules

* A Rule may be rejected though a Meta Referendum carrying at least 50% approval.

## 9 Elections and Events
...
#### 9.1.1 Simulated voting

* Any Rule made relating to the conduct of canon elections must use full simulated voting, unless—
    * the vote would change the fundamental nature or symbols of the simulation;
...
### 10.2 Use of real symbols and logos
...
### 11.1 General procedure for amending Meta Constitution
...
* This Meta Constitution may be amended after—
    ...
    * a five-day consultation period where members may provide feeedback; and
    * presentation of a final draft; and
    * a Meta Referendum on that final draft.
